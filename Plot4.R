FourthPlot <- function(){
  ...
  globalReactivePower <- as.numeric(dataDilterByDate$Global_reactive_power)
  voltage <- as.numeric(dataDilterByDate$Voltage)
  subMetering1 <- as.numeric(dataDilterByDate$Sub_metering_1)
  subMetering2 <- as.numeric(dataDilterByDate$Sub_metering_2)
  subMetering3 <- as.numeric(dataDilterByDate$Sub_metering_3)
